...
public class CustomerFirstApprovalTest {
	...
	public void loginToApplication() throws InterruptedException {
		...
		alert.accept();
		loginPage.sendUserNameCustomerApproval();
	...
	@Test
	public void customerFirstApprovalTest() throws InterruptedException {
		...
		allMasterSubModules.clickOnOtherMasterMenu();
		allMasterSubModules.clickOnCustomersForApprovalMenu();
		...
		customersForApprovalPage.firstApproveCustomer();
	}

	// customerFirstApprovalTest2


	@Test
	public void customerFirstApprovalTest2() throws InterruptedException {
		selectPlant.selectPlantTwo();
		System.out.println("Selected plant two");
