...
public class InvoiceCreationTestDomesticSamplePOAndOutward {
	...
	@Test //(enabled = false)
	public void invoiceCreationFromExcelDomesticSample() throws InterruptedException {
		...
		sheetName = "SamplePOInvoice";

		manageInvoicePage.createInvoiceSamplePo(excelPath, sheetName, driver);
