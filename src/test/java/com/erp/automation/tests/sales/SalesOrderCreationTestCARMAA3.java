...
public class SalesOrderCreationTestCARMAA3 {
// CAA -create,Reject,Modify, Approve1,Approve2
	WebDriver driver;
	...
	@Test(priority = 3)
	public void soSecondApprovalRejectionTest() throws InterruptedException {
		...
		soApprovalPage.sendSoNoInSearchFieldToOpenSo();
		manageSalesOrderPage.sendRemarkOnReject();
	...
	@Test(priority = 4)
	public void salesOrderModificationTest() throws InterruptedException {
		...
		soApprovalPage.clickOnEditButton();
		manageSalesOrderPage.soModification();

	}

	@Test(priority = 5)
	public void soFirstApprovalTestSecondTime() throws InterruptedException {
