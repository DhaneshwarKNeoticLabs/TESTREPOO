...
public class CustomerPriceListApprovalTest {
	...
	String sheetName;
	String excelPath;
	ApprovalPriceListPage approvalPriceListPage;
	...
	public void launchErpSite() throws InterruptedException {
		...
		approvalPriceListPage =new ApprovalPriceListPage(driver);
	...
	public void loginToApplication() throws InterruptedException {
		...
		alert.accept();
		loginPage.sendUserNameCustomerPriceApproval();
	...
	@Test
	public void customerPriceListApprovalProcess() throws InterruptedException {
		...
		allSalesSubModules.clickOnApprovalCustomerPriceListMenu();
		...
		approvalPriceListPage.customePriceListApprovalProcess(excelPath, sheetName, driver);
