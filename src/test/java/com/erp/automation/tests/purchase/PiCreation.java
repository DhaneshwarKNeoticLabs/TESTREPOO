...
public class PiCreation {
	   ...
	   ExtentTest test;
	    ...
	    public void launchErpSite() {
	       ...
	       test = ExtentManager.createTest("Pi creation Test");
	    ...
	    @Test
	    public void piCreationTest() throws InterruptedException {
	       ...
	       managePurchaseIndentPage.clickOnStoreDropdownOptionsSelectRawMaterial();
	   ...
	   //   managePurchaseIndentPage.enterValuesInQtyRemPurpose();
			...
			// Store it
			 TestDataStorage.piNumber = piNumber;
			 System.out.println(piNumber);
			 managePurchaseIndentPage.okButtonFromFinalSuccessPopUp();
//	       managePurchaseIndentPage.enterInItemCodeField();
//	       managePurchaseIndentPage.enterValuesInQtyRemPurpose();
//	       managePurchaseIndentPage.clickOnSaveButton();
//
//	       managePurchaseIndentPage.clickOnOkButtonFromWarningPopUp();
